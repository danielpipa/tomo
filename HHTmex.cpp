                 ...
                 int nrhs, const mxArray *prhs[] )
{
	...
	cv::Mat WFS01;
	shift(temp,WFS01,Point2f(-y_shift.at<double>(i),-x_shift.at<double>(i)), BORDER_CONSTANT, 0);
	// #WFS 1
	i = 1;
	copyMakeBorder(WFS1, temp, crop, crop, crop, crop, BORDER_CONSTANT, 0);	//Pad array
	cv::Mat WFS11;
	shift(temp,WFS11,Point2f(-y_shift.at<double>(i),-x_shift.at<double>(i)), BORDER_CONSTANT, 0);
	// #WFS 2
	i = 2;
	copyMakeBorder(WFS2, temp, crop, crop, crop, crop, BORDER_CONSTANT, 0);	//Pad array
	cv::Mat WFS21;
	shift(temp,WFS21,Point2f(-y_shift.at<double>(i),-x_shift.at<double>(i)), BORDER_CONSTANT, 0);
	// #WFS 3
	i = 3;
	copyMakeBorder(WFS3, temp, crop, crop, crop, crop, BORDER_CONSTANT, 0);	//Pad array
	cv::Mat WFS31;
	shift(temp,WFS31,Point2f(-y_shift.at<double>(i),-x_shift.at<double>(i)), BORDER_CONSTANT, 0);
	// #WFS 4
	i = 4;
	copyMakeBorder(WFS4, temp, crop, crop, crop, crop, BORDER_CONSTANT, 0);	//Pad array
	cv::Mat WFS41;
	shift(temp,WFS41,Point2f(-y_shift.at<double>(i),-x_shift.at<double>(i)), BORDER_CONSTANT, 0);
