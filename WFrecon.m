function [layer1WF] = WFrecon(layersX,layersY,sizes,d,tol)
...
%layer2 = layers(sizes(1)^2+1:sizes(1)^2+sizes(2)^2);

%layer3 = layers(sizes(1)^2+sizes(2)^2+1:sizes(1)^2+sizes(2)^2+sizes(3)^2);
